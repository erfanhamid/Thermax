...
{
    public class EmployeeMBalanceCalculationBridge
    {

        public static bool InsertUpdateEMCOB(ref BEEContext context, EMCOB mcob)
        {
            var emcbal = context.EmcBalanceCalculation.FirstOrDefault(x => x.DocID == mcob.EmployeeId && x.DocType == "EITOB" && x.EmpID == mcob.EmployeeId);
        ...
        public static bool DeleteEMCOB(ref BEEContext context, EITOB mcob)
        {
